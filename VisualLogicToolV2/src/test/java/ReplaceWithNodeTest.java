...
import com.visuallogictool.application.nodes.baseclassimpl.ReplaceWithNode;
import com.visuallogictool.application.nodes.baseclassimpl.ReplaceWithNodeConfiguration;

import akka.actor.ActorRef;
import akka.actor.ActorSystem;
import akka.actor.Props;
import akka.testkit.javadsl.TestKit;
public class ReplaceWithNodeTest {

	private ActorRef replaceWithNode;
		  ...
		  new TestKit(system) {
		      {
		        //String id, String logId, String flowId, AppendNodeConfiguration appendNodeConfiguration
		    	  ReplaceWithNodeConfiguration replaceWithNodeConfiguration = new ReplaceWithNodeConfiguration("var","jour","soir","");
		    	  TestKit parent = new TestKit(system);
		    	  ActorRef child = parent.childActorOf(Props.create(ReplaceWithNode.class,"1","AN","coucou",replaceWithNodeConfiguration));
		    	  ...
		    	  assertEquals(var,"bonsoir");
		    	  
		       
		    	  
		    	  replaceWithNodeConfiguration = new ReplaceWithNodeConfiguration("var","jour","soir","bla");
		    	  ActorRef child2 = parent.childActorOf(Props.create(ReplaceWithNode.class,"1","AN","coucou",replaceWithNodeConfiguration));

		    	  //Check if the child has been created
		    	  parent.expectMsgClass(Duration.ofSeconds(1), NodeCreated.class);
		    	
		    	  
		    	  nextActorMessage = new NextActors(listNextActor);		    	  
