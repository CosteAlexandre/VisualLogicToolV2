...
import com.visuallogictool.application.nodes.baseclassimpl.CutBeginningNode;
import com.visuallogictool.application.nodes.baseclassimpl.CutBeginningNodeConfiguration;
...
public class CutBeginningNodeTest {

	private ActorRef cutBegginingNode;
		  ...
		  new TestKit(system) {
		      {
		        //String id, String logId, String flowId, AppendNodeConfiguration appendNodeConfiguration
		    	  CutBeginningNodeConfiguration cutBeginningNodeConfiguration = new CutBeginningNodeConfiguration("var",2,"");
		    	  TestKit parent = new TestKit(system);
		    	  ActorRef child = parent.childActorOf(Props.create(CutBeginningNode.class,"1","AN","coucou",cutBeginningNodeConfiguration));
		    	  ...
		    	  assertEquals(var,"ucou");
		    	  
		       
		    	  cutBeginningNodeConfiguration = new CutBeginningNodeConfiguration("var",2,"bla");
		    	  ActorRef child2 = parent.childActorOf(Props.create(CutBeginningNode.class,"1","AN","coucou",cutBeginningNodeConfiguration));
