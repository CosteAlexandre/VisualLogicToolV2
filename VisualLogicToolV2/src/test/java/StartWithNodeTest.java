...
import com.visuallogictool.application.nodes.baseclassimpl.StartWithNode;
import com.visuallogictool.application.nodes.baseclassimpl.StartWithNodeConfiguration;

import akka.actor.ActorRef;
import akka.actor.ActorSystem;
import akka.actor.Props;
import akka.testkit.javadsl.TestKit;
public class StartWithNodeTest {

	private ActorRef startWithNode;
		  ...
		  new TestKit(system) {
		      {
		        //String id, String logId, String flowId, AppendNodeConfiguration appendNodeConfiguration
		    	  StartWithNodeConfiguration startWithNodeConfiguration = new StartWithNodeConfiguration("var","la");
		    	  TestKit parent = new TestKit(system);
		    	  ActorRef child = parent.childActorOf(Props.create(StartWithNode.class,"1","AN","coucou",startWithNodeConfiguration));
